...
import { ExistingScreenshotPicker } from '../components/admin/ExistingScreenshotPicker';
...
function ContentStudio() {
    ...
    return <div className="studio-page animate-in">
        ...
        {activeTab === 'content' && <ContentList items={items} onEdit={openExisting} onCreate={openCreate} onReplace={openReplace} onRefresh={refresh} loading={loading} canRecover={auth.isOwner} />}
